...
class WifiNetworkAdapter(private val context: Context, private var wifiNetworks: List<WifiNetwork>)
...
//        }
    ...
    fun updateData(newWifiNetworks: List<WifiNetwork>?) {
        wifiNetworks = newWifiNetworks ?: wifiNetworks
